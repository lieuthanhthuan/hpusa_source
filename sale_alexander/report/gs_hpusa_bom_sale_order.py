...
report_sxw.report_sxw('report.alex.bom.sale.order', 'sale.order', 'addons/sale_alexander/report/gs_hpusa_bom_sale_order.rml', parser=gs_bom_order, header="external")
...
class gs_bom_order_cost(report_sxw.rml_parse):
    ...
    def get_price_list_version(self,cr,uid,ids,price_list,amount,context=None):
        ...
        return val_return
    # hpusa configures 29-05-2015
report_sxw.report_sxw('report.alex.bom.sale.order.cost', 'sale.order', 'addons/sale_alexander/report/gs_hpusa_bom_sale_order.rml', parser=gs_bom_order_cost, header="external")
