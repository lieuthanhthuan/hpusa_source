...
class gs_bom_order_vn(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(gs_bom_order_vn, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.gs.bom.sale.order.vn', 'sale.order', 'addons/gs_hpusa_order/report/gs_hpusa_bom_sale_order_vn.rml', parser=gs_bom_order_vn, header="external")

class gs_bom_order_vn_cost(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(gs_bom_order_vn_cost, self).__init__(cr, uid, name, context=context)
        self.localcontext.update({
            'time': time,
            'get_bom': self.get_bom,
    ...
    def get_price_list_version(self,cr,uid,ids,price_list,amount,context=None):
        ...
        return val_return
     # hpusa configures 29-05-2015
report_sxw.report_sxw('report.gs.bom.sale.order.vn.cost', 'sale.order', 'addons/gs_hpusa_order/report/gs_hpusa_bom_sale_order_vn.rml', parser=gs_bom_order_vn_cost, header="external")
